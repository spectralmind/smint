...
var BrowserDetection = {
	...
	noticeText: {
    	   ...
    	   'spectralmind': {"title": "Unsupported browser detection!", "notice": "You are using an unsupported browser. Using your current browser will prevent you from accessing advanced features of SEARCH by Sound, including: <ul><li>Search by uploaded track</li><li>Segmented search</li></ul>.", "selectBrowser": "Use the links below to download a new browser or upgrade your existing browser.", "remindMeLater": "Remind me later", "neverRemindAgain": "No, don't remind me again" }
	}
};
