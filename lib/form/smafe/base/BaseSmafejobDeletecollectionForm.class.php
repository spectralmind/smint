...
/**
 * SmafejobDeletecollection form base class.
 *
 * @method SmafejobDeletecollection getObject() Returns the current form's model object
 *
 * @package    smint
 * @subpackage form
 * @author     Wolfgang Jochum, Spectralmind GmbH
 */
abstract class BaseSmafejobDeletecollectionForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('smafejob_deletecollection[%s]');
