...
abstract class BaseConfigPeer {
	...
	const CLASS_DEFAULT = 'lib.model.smafe.Config';
	...
	const MODIFIED = 'config.MODIFIED';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Key', 'Value', 'Modified', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('key', 'value', 'modified', ),
		BasePeer::TYPE_COLNAME => array (self::KEY, self::VALUE, self::MODIFIED, ),
		BasePeer::TYPE_FIELDNAME => array ('key', 'value', 'modified', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Key' => 0, 'Value' => 1, 'Modified' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('key' => 0, 'value' => 1, 'modified' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::KEY => 0, self::VALUE => 1, self::MODIFIED => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('key' => 0, 'value' => 1, 'modified' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		$criteria->addSelectColumn(ConfigPeer::KEY);
		$criteria->addSelectColumn(ConfigPeer::VALUE);
		$criteria->addSelectColumn(ConfigPeer::MODIFIED);
	}
    ...
    foreach (sfMixer::getCallables('BaseConfigPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseConfigPeer', $values, $con))
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ConfigPeer::KEY);
			$selectCriteria->add(ConfigPeer::KEY, $criteria->remove(ConfigPeer::KEY), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(ConfigPeer::KEY, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ConfigPeer::KEY, $pk);
