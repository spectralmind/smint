...
abstract class BaseTrack extends BaseObject  implements Persistent {
	...
	public function setFingerprint($v)
	{
		...
		if ($this->fingerprint !== $v) {
			$this->fingerprint = $v;
			$this->modifiedColumns[] = TrackPeer::FINGERPRINT;
		}
	...
	public function setInserted($v)
	{
		...
		if ( $this->inserted !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TrackPeer::INSERTED;
			}
	...
	public function setUpdated($v)
	{
		...
		if ( $this->updated !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TrackPeer::UPDATED;
			}
		} // if either are not null
	...
	/**
	 * Set the value of [mbid] column.
	 * 
	 * @param      int $v new value
	 * @return     Track The current object (for fluent API support)
	 */
	public function setMbid($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->mbid !== $v) {
			$this->mbid = $v;
			$this->modifiedColumns[] = TrackPeer::MBID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->inserted = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->updated = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->mbid = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = TrackPeer::NUM_COLUMNS - TrackPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setInserted($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setUpdated($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setMbid($arr[$keys[4]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TrackPeer::FINGERPRINT)) $criteria->add(TrackPeer::FINGERPRINT, $this->fingerprint);
		if ($this->isColumnModified(TrackPeer::INSERTED)) $criteria->add(TrackPeer::INSERTED, $this->inserted);
		if ($this->isColumnModified(TrackPeer::UPDATED)) $criteria->add(TrackPeer::UPDATED, $this->updated);
		if ($this->isColumnModified(TrackPeer::MBID)) $criteria->add(TrackPeer::MBID, $this->mbid);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Track has previously been saved, it will retrieve
	 * related Files from storage. If this Track is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
