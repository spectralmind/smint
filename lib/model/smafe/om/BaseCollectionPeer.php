...
abstract class BaseCollectionPeer {
	...
	const CLASS_DEFAULT = 'lib.model.smafe.Collection';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'CollectionName', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'collectionName', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::COLLECTION_NAME, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'collection_name', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CollectionName' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'collectionName' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::COLLECTION_NAME => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'collection_name' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CollectionPeer::COLLECTION_NAME);
	}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCollectionPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCollectionPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCollectionPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCollectionPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCollectionPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCollectionPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCollectionPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCollectionPeer', $values, $con, $ret);
    }
	...
	{
	  return array(array('collection_name'));
	}
