...
abstract class BaseConfig extends BaseObject  implements Persistent {
	...
	{
		$this->modified = '-99999--99999--99999T-99999:-99999:-99999+0000';
	}
	...
	public function setKey($v)
	{
		...
		if ($this->key !== $v) {
			$this->key = $v;
			$this->modifiedColumns[] = ConfigPeer::KEY;
		}
	...
	public function setModified($v)
	{
		...
		if ( $this->modified !== null || $dt !== null ) {
			...
			$currNorm = ($this->modified !== null && $tmpDt = new DateTime($this->modified)) ? $tmpDt->format('Y-m-d\\TH:i:sO') : null;
			...
			{
				$this->modified = ($dt ? $dt->format('Y-m-d\\TH:i:sO') : null);
				$this->modifiedColumns[] = ConfigPeer::MODIFIED;
			}
	...
	{
			if ($this->modified !== '-99999--99999--99999T-99999:-99999:-99999+0000') {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->modified = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->resetModified();
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setModified($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ConfigPeer::KEY)) $criteria->add(ConfigPeer::KEY, $this->key);
		if ($this->isColumnModified(ConfigPeer::VALUE)) $criteria->add(ConfigPeer::VALUE, $this->value);
		if ($this->isColumnModified(ConfigPeer::MODIFIED)) $criteria->add(ConfigPeer::MODIFIED, $this->modified);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ConfigPeer::KEY, $this->key);
